  ...
  return (
    <footer className="bg-gradient-to-r from-yellow-400 to-orange-500 text-white py-20">
      ...
      <div className="max-w-9xl mx-auto text-center">
        <div className="bg-white/20 text-white py-10 px-6 rounded-2xl max-w-7xl mx-auto">
      ...
      <div className="max-w-15xl mx-auto mt-10 grid grid-cols-1 md:grid-cols-3 gap-6 text-2xl text-center">
        {/* Important Links */}
        <div>
