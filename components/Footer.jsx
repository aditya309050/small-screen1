  ...
  return (
    <footer className="bg-gradient-to-r from-yellow-400 to-orange-500 text-white py-20 ">
      ...
      <div className="max-w-15xl mx-auto mt-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 text-2xl ">
        {/* Important Links */}
        <div>
          <h3 className="font-semibold text-3xl sm:text-2xl p-7 lg:p-72 lg:-mt-60 ">Important Links</h3>
          <ul className="-mt-2 space-y-1 p-7 lg:p-72 lg:-mt-120 ">
        ...
        {/* Contact Section */}
        <div>
          <h3 className="font-semibold text-3xl sm:text-xl p-7 lg:p-50 lg:-mt-32 ">Contact Us</h3>
          <p className="mt-7 font-thin p-5 lg:p-30 lg:-mt-52">info@smallscreenmarketing.com</p>
        </div>

        {/* Social Links */}
        <div>
          <h3 className="font-semibold text-3xl sm:text-xl p-7 lg:p-55 lg:-mt-42 ">Follow Us:</h3>
          <img 
          className='w-30 h-30 p-7 -mt-5 lg:ml-50 lg:-mt-42 '
